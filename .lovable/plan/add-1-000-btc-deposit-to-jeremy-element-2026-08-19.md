# Add $1,000 BTC Deposit to Jeremy Element

## Current state (verified)

- BTC balance: `0.03879337` BTC (~$2,463.09)
- USDT balance: `0.00`
...
Existing balance                         0.03879337 BTC
--------------------------------------------------------
New BTC balance                          0.05454236 BTC
New USD value    0.05454236 x 63,496.12 = ~$3,463.09
```

## Changes (data only)

1. Update Jeremy's BTC row in wallet balances to `0.05454236`.
...
4. Insert an admin audit log entry with before/after BTC balance and a reason noting the $1,000 BTC credit.

## Notes

- No code changes: dashboard, portfolio breakdown, deposit history and transaction history all read live from the database.
- Active plan principal and accrued ROI stay untouched; only the available portfolio balance increases.
