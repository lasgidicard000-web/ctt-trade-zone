...
const plans: Plan[] = [
  ...
  {
    id: "field",
    name: "Field Marshal Plan",
    tagline: "The Highest Tier — Admin-Approved Payouts",
    marketing:
      "Our top tier. Returns are not guaranteed and depend on actual performance. Payouts to your external wallet are requested by you and reviewed and approved by an admin — nothing is sent automatically.",
    minDeposit: 10000,
    dailyROI: "Not guaranteed",
    duration: "90 days",
    salary: "—",
    minWithdrawal: "$10",
    reinvestment: "Fully allowed",
    bonus: "Lowest withdrawal fee (0.25%) and $50,000 daily cap",
    todayPerf: 0,
    weekPerf: 0,
    monthPerf: 0,
    perfRange: [0, 0],
    ...
    dashboard: [
      ...
      "Admin-reviewed payout queue",
      "Enterprise-grade analytics",
      "Personalized reports",
    ],
    privileges: [
      "0.25% withdrawal fee",
      "$50,000 daily withdrawal cap",
      "Priority support",
      "Premium features & community access",
      "Field Marshal badge",
    ],
    referral: {
      levels: ["Level 1: 15%", "Level 2: 6%", "Level 3: 4%"],
      activation: "—",
      extra: "Field Marshal ambassador privileges",
    },
    badge: "Field Marshal",
    ...
    aiStrategy: "Institutional-Grade AI Engine",
    riskLevel: "Aggressive",
    projection: "Returns not guaranteed",
  },
];
